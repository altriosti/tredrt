...
class WhitelistJourney {
  ...
  async runOpening() {
    ...
    const corridor = new DimensionalTransition({ colorA: 0x2f6bd6, colorB: 0xffe3b0, seed: 11, length: 1700 });
  ...
  async afterIdentify() {
    ...
    await this.travelTo('living', { a: 0xffc46b, b: 0x9dffe0, duration: 5.6 });
  ...
  async finalSequence() {
    ...
    await this.travelTo('final', { a: 0x9dffe0, b: 0xd7c4ff, duration: 7.5, length: 2200 });
