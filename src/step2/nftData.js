...
// Token metadata and device palettes. The artwork files are the real collection
// images, used as the identity source inside the 3D injection chamber.
// Universe and planet names are NOT here: those come from the supplied CSV.
// -----------------------------------------------------------------------------
...
// Destinations are resolved from the supplied CSV by TokenID — see
// destinationRegistry.js. Nothing in this file decides where a token goes.
